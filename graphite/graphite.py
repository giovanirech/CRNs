...
if __name__ == '__main__':
	...
	for p in perc_list:
		...
		atoms = crystal(('C','C'), [(0,0,0.25), (1/3,2/3,0.25)], spacegroup=194, cellpar=[2.464, 2.464, 6.711, 90, 90, 120])
		...
		new_a = (factor_mul**(1./3)) * atoms.get_cell()[0]

		atoms.set_cell([new_a, new_a, 6.711, 90, 90, 90], scale_atoms=True)
