...
def cubic_criterion(C):
	...
	if statistics.stdev([C['C11'],C['C22'],C['C33']])>LIMIT:
		return False

	if statistics.stdev([C['C12'],C['C13'],C['C23']])>LIMIT:
		return False

	if statistics.stdev([C['C44'],C['C55'],C['C66']])>LIMIT:
		return False
...
def get_elastic_constants():
	...
	line = subprocess.check_output("grep -A 5 'Elastic Constant Matrix: (Units=GPa)'  gulp.got | tail -1", shell=True)
	...
	line = subprocess.check_output("grep -A 6 'Elastic Constant Matrix: (Units=GPa)'  gulp.got | tail -1", shell=True)
	...
	line = subprocess.check_output("grep -A 7 'Elastic Constant Matrix: (Units=GPa)'  gulp.got | tail -1", shell=True)
	...
	line = subprocess.check_output("grep -A 8 'Elastic Constant Matrix: (Units=GPa)'  gulp.got | tail -1", shell=True)
	...
	line = subprocess.check_output("grep -A 9 'Elastic Constant Matrix: (Units=GPa)'  gulp.got | tail -1", shell=True)
	...
	line = subprocess.check_output("grep -A 10 'Elastic Constant Matrix: (Units=GPa)'  gulp.got | tail -1", shell=True)
